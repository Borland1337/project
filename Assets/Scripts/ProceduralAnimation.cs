...
public class ProceduralAnimation : MonoBehaviour
{
    ...
    private int nbLegs;
    public Vector3 ZBody;
    public float OrientationScale = 25f;
    ...
    void FixedUpdate()
    {
        ...
        {
            Vector2 v1 = (legTargets[0].position - legTargets[3].position).normalized;

            Vector3 v2 = ZBody;
            Vector3 normal = Vector3.Cross(v1, v2).normalized;
            Vector3 up = Vector3.Lerp(lastBodyUp, normal, 1f / (float)(smoothness + OrientationScale));
            transform.up = up;
